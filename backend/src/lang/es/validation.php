...
/**
 * Traducciones de validación en castellano.
 *
 * Se usan como mensaje por defecto para cualquier regla de validación que no
 * tenga un mensaje personalizado en el método messages() de cada FormRequest.
 * Garantiza que todos los errores de validación se devuelvan en español.
 */
...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensajes de validación personalizados por atributo
    |--------------------------------------------------------------------------
    */
    'custom' => [
        'attribute-name' => [
    ...
    /*
    |--------------------------------------------------------------------------
    | Nombres de atributos personalizados (en castellano)
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'nombre' => 'nombre',
